...
date = "2026-05-05"
description = "A deep dive into how the OAuth 2.0 On-Behalf-Of flow threads user identity through a Microsoft Foundry agent all the way to Cosmos DB row-level access, and why this pattern matters for every AI agent that touches sensitive data."

[taxonomies]
tags = ["Microsoft ISE", "Software", "Azure", "Security"]
